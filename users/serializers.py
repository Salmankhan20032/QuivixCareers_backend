...
class UserProfileSerializer(serializers.ModelSerializer):
    # This remains mostly the same, just a bit cleaner
    ...
    # --- THIS IS THE CRUCIAL NEW PART, MY LOVE! ---
    def to_representation(self, instance):
        """
        Convert `profile_picture` to a full URL.
        """
        ...
        if instance.profile_picture:
            ...
            if request is not None:
                # build_absolute_uri() creates the full URL (e.g., http://127.0.0.1:8000/media/...)
